...
<?php include "all_functions.php"; ?><!-- Including Functions File -->
<?php include "includes/admin_navigation.php"; ?><!-- Including Navigation File -->
<link rel="stylesheet" href="groups_add.css"><!-- Including Css File -->
<!-- QUERY TO SHOW GROUP NAME AND STATUS -->
<?php
 $query = "SELECT * FROM groups WHERE group_id = {$_GET['source']} ";//Query to select particular group using group_id from GET method
...
<div>
<div class="row"><!-- Creating a row -->
          <div class="col-md-6"><!-- Creating a card to show Graph for Monthly Group Expenses -->
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-title">Expenses(Monthly)</h5><!-- Graph Header -->
              </div>
              <div class="card-body embed-responsive table-responsive">
                <form action="#" method="post"><!-- Creating Form to Select Year -->
                    <select name="select1"> 
              ...
              <div id="columnchart_material" ></div><!-- Creating Column Chart to show Monthly Expenses of group -->
              </div>
          ...
          <div class="col-md-6"><!-- Creating a card to shoe Graph for Weekly Group Expenses -->
            <div class="card card-chart">
              <div class="card-header">
              <h5 class="card-title">Expenses(Weekly)</h5><!-- Graph Header -->
              </div>
              <div class="card-body embed-responsive table-responsive">
                <form action="#" method="post"><!-- Creating Form to Select Year And Month -->
                    <select name="select2"> <!-- Select year -->
                    ...
                    <select name="select3" size='1'><!-- Select Month -->
                    <?php
                    for ($i = 0; $i < 12; $i++) {
              ...
              <div id="columnchart_material1" ></div><!-- Creating Column Chart to show Weekly Group Expenses -->
              </div>
              <div class="card-footer">
                <hr>
                <div class="stats">
...
if($_SESSION['user_id'] == $admin_id){ ?>
    <div class="d-inline"><!-- Add Members Button to add friends in group -->
            <button name="button" class="btn btn-primary" id="0">Add Members</button>
            <br><br>
            <form  id="add" class="col-lg-8" action="" method="post"><!-- Form to insert username -->
              <div class="d-inline-block">
                <label>*Friends Only</label>
                <span><input type="text" name="friend" class="form-group" placeholder="Enter Valid Username"></span>
                <span><button name="add_members" type="submit">ADD</button></span><!-- Submit button -->
              </div>
            </form><!-- End of form -->
    </div>
<?php } ?>
...
if($_SESSION['user_id'] == $admin_id){ ?>
            ...
            <br><br>
            <form  id="delete" class="col-lg-8" action="" method="post"><!-- form to insert username -->
                <div class="d-inline-block"><!-- Delete members button to delete friends from groups -->
                    <label>*Friends Only</label>
                    <span><input type="text" name="friend" class="form-group" placeholder="Enter Valid Username"></span>
                    <span><button name="delete_members" type="submit">DELETE</button></span><!-- Submit button -->
                </div>
            </form><!-- End of Form -->
<?php } ?>
...
<br><br>
<!-- Add expense button to add new expenses in group -->
        <div class="d-inline-block table-responsive">
            <span><form id="group" class="form-check-inline" action="" method="post" onsubmit="return check();"><!-- Creating form to add expenses -->
                <span><div class="jumbotron embed-responsive-1by1" id="new">
                        <?php if($_SESSION['user_id'] == $admin_id){ ?><!-- Select dropdown to select members to add in expense -->
                            ...
                            <?php    //query to show all members that are in group
                        ...
                        <br><br>
                <div>
                <i class="fa fa-sticky-note" aria-hidden="true"></i><!-- input field to enter Expense Description -->
            ...
            <!-- CURRENCY SELECTOR TYPE -->
                ...
                <div>
                <input type="submit" class="btn btn-primary" name="add_expense" value="SUBMIT"><!-- Form submit button -->
                </div>          
            </div></span>           
...
<!-- FORM 2 SHOWING SPLIT TYPE -->
            ...
            <span><div class="container" >
              <div class="jumbotron" id="new2"><!-- Form part 2 to select bill splitting type -->
                <div>
            ...
            <span><div class="container" >
            <div class="jumbotron" style="width:250px;" id="new3"><!-- From part 3 to select members to type exact bill -->
            <div>
...
// JS to check if number is inserted in net money paid field and description length
function check(){
...
// JS to update currecy symbol on changing selection option
...
<!-- JS to insert google chart to show monthly expenses in a group -->
<script type="text/javascript">
          ...
          function drawChart() {
            var data = google.visualization.arrayToDataTable([
              ...
              // Query to select monthly expenses in selected group
...
<!-- JS to insert google chart to show weekly group expenses -->
<script type="text/javascript">
          google.charts.load('current', {'packages':['corechart','bar']});
          google.charts.setOnLoadCallback(drawChart);
          function drawChart() {
            ...
            // Query to select weekly expenses of selected group
